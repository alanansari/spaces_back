...
router.post('/newpost',validation.authverifytoken, Upload.uploadfile.single('image'), postController.newpost);
...
router.delete('/deletepost/:id',validation.authverifytoken,postController.dltpost);
